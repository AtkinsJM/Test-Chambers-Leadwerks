Script.destinationWaypoint = nil --entity "Destination waypoint"

function Script:Start()
	self.entity:SetKeyValue("tag", "Teleport")
	if self.destinationWaypoint ~= nil then
		local string waypointName = self.destinationWaypoint:GetKeyValue("name");
		self.entity:SetKeyValue("destinationWaypoint", waypointName);
	end
