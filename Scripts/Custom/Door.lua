Script.requiredKeyType = 0 --choice "Required key type" "Blue, Red, Yellow, Green, Orange, Purple"

function Script:Start()
	self.entity:SetKeyValue("tag", "Door")
	self.entity:SetKeyValue("requiredKeyType", math.pow(2, self.requiredKeyType))
end
